...
%prep
%setup -q -n image-1.5.32
cd %{_builddir}/image-1.5.32
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590371762
...
cp %{_builddir}/image-1.5.32/LICENSE %{buildroot}/usr/share/package-licenses/image/2ccbe68aaa162ca353516aa5bc84e95ac707a894
